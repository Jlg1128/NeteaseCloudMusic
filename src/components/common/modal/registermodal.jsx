      ...
      <div>
        ...
        >
          <div className={cssobj.phoneInput}>
            <Input
              className={cssobj.phonenumber}
              onChange={e => this.handleinput('phone', e.currentTarget.value)}
              placeholder="请输入手机号"
            />
            <Input.Password
              className={cssobj.password}
              onChange={e =>
                this.handleinput('password', e.currentTarget.value)
              }
              placeholder="请输入密码"
            />
            <div>
