            ...
            <div className={cssobj.regisiter_style}>
              <ul>
                <li>
                  ...
                  <a href="" className={cssobj.enterstyle}>
                    微信登录
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="">
                    <div>
                      <img src="/static/weibologo.png" alt="" />
                    </div>
                  </a>
                  <a href="" className={cssobj.enterstyle}>
                    微博登录
...
function mapStateToProps(state) {
  return {
    ...
    registervisible: state.recommend.registervisible,
  };
}
