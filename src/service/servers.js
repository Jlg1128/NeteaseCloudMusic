...
export const getRecommendMusicInfo = () => {
  ...
  var getIndexSwiper = new Promise((resolve, reject) => {
    return request('http://localhost:3000/banner')
      .then(res => resolve({IndexSwiper:res.banners}))
  ...
  return Promise.all([getIndexSwiper,getRecommendMusic,getHotJoinedSinger,getHotZhubolist,
                         getNewestAblum,gettoplisthot,gettoplistnewest,gettoplistorigin])
                         .then(res=>{
